package com.codingflow.tictactoe;
...
//                Toast.makeText(MainActivity.this, "Next Selected", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(MainActivity.this,Help.class));//start activity
                break;
//
//
//            case R.id.item3:
////                Toast.makeText(MainActivity.this, "Next Selected", Toast.LENGTH_SHORT).show();
//                startActivity(new Intent(MainActivity.this,AboutUs.class));//start activity
//                break;
